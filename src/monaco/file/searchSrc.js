...
export const readText_Model = async (lib, file, member, r_handle, rootHandleName) => {
    let libHandle = null;
    let fileHandle = null;
    ...
    let new_uri = await createURI(rootHandleName, libHandle.name, file, filename_c, source_File.time, lang);
